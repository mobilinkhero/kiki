...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($cacheStatus)): ?>
                    <div
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3 text-xs">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($cacheStatus['last_cleared'])): ?>
                            <div>
                ...
                <ul class="divide-y divide-neutral-200 dark:divide-neutral-500/30">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $cacheSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex flex-col sm:flex-row  sm:items-center sm:space-y-0">
                            <div class="grow flex items-start space-x-4">
                                ...
                                <div class="shrink-0 mt-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'framework'): ?>
...
</div><?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/Modules/CacheManager/resources/views/livewire/tenant/settings/system/cache-management-settings.blade.php ENDPATH**/ ?>