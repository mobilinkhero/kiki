...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$permission || checkPermission($permission)): ?>
<a wire:navigate href="<?php echo e($route ? route($route) : '#'); ?>" class="<?php echo e($linkClasses); ?>" <?php if($tooltip && $collapsed): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($icon && !empty($icon)): ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/components/admin/sidebar-navigation-item.blade.php ENDPATH**/ ?>