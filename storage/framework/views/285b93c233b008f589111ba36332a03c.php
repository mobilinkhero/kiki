        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('E-commerce Dashboard')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isConfigured): ?>
                <div class="flex gap-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($stats['total_products'] ?? 0) > 0): ?>
                        <button wire:click="clearAllProducts" 
                                wire:confirm="Are you sure you want to clear all <?php echo e($stats['total_products']); ?> products? This action cannot be undone. You'll need to sync again to restore products from your sheet."
                    ...
                    <a href="<?php echo e(tenant_route('tenant.ecommerce.setup')); ?>" 
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($stats['total_products'] ?? 0)); ?></p>
                        </div>
                    ...
                    <div class="mt-4">
                        <p class="text-sm text-gray-500">
                            <span class="text-green-600 font-medium"><?php echo e($stats['active_products'] ?? 0); ?></span> active
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($stats['low_stock_products'] ?? 0) > 0): ?>
                                • <span class="text-red-600 font-medium"><?php echo e($stats['low_stock_products']); ?></span> low stock
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($stats['total_orders'] ?? 0)); ?></p>
                        </div>
                    ...
                    <div class="mt-4">
                        <p class="text-sm text-gray-500">
                            <span class="text-orange-600 font-medium"><?php echo e($stats['pending_orders'] ?? 0); ?></span> pending
                            • <span class="text-green-600 font-medium"><?php echo e($stats['completed_orders'] ?? 0); ?></span> completed
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white">$<?php echo e(number_format($stats['total_revenue'] ?? 0, 2)); ?></p>
                        </div>
                    ...
                    <div class="mt-4">
                        <p class="text-sm text-gray-500">
                            This month: <span class="text-green-600 font-medium">$<?php echo e(number_format($stats['monthly_revenue'] ?? 0, 2)); ?></span>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-green-600 dark:text-green-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($config && $config->last_sync_at): ?>
                                    Synced
                                <?php else: ?>
                                    Never synced
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($config && $config->last_sync_at): ?>
                        <div class="mt-4">
                            <p class="text-sm text-gray-500"><?php echo e($config->last_sync_at->diffForHumans()); ?></p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="<?php echo e(tenant_route('tenant.ecommerce.orders')); ?>" 
                        ...
                        <a href="<?php echo e(tenant_route('tenant.ecommerce.analytics')); ?>" 
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($stats['recent_orders']) || count($stats['recent_orders']) == 0): ?>
                    ...
                    <?php else: ?>
                        <div class="space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stats['recent_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 bg-blue-100 dark:bg-blue-800/50 rounded-lg flex items-center justify-center">
                                            <span class="text-blue-600 dark:text-blue-400 font-bold text-sm">#<?php echo e(substr($order->order_number, -4)); ?></span>
                                        </div>
                                        <div>
                                            <p class="font-medium text-gray-900 dark:text-white"><?php echo e($order->customer_name); ?></p>
                                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($order->created_at->format('M j, Y')); ?></p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-medium text-gray-900 dark:text-white">$<?php echo e(number_format($order->total_amount, 2)); ?></p>
                                        <span class="inline-block px-2 py-1 text-xs rounded-full 
                                                   <?php if($order->status === 'pending'): ?> bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300
                                                   <?php elseif($order->status === 'confirmed'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300
                                                   <?php elseif($order->status === 'delivered'): ?> bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300
...
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/tenant/ecommerce/dashboard.blade.php ENDPATH**/ ?>