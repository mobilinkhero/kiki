...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-8 w-8 text-danger-500 dark:text-danger-400']); ?>
...
<?php endif; ?>
        ...
        <div class="p-6">
            <h2 class="text-xl sm:text-2xl font-bold text-center text-gray-900 dark:text-white mb-4">
                <?php echo e(t('your_account_is_discconected')); ?>

            </h2>
            <p class="text-gray-600 dark:text-gray-300 text-center mb-6 text-sm sm:text-base">
                <?php echo e(t('disconnected_info')); ?>

            </p>

            <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                <a href="<?php echo e(tenant_route('tenant.connect')); ?>" target="_blank" rel="noopener noreferrer"
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <?php echo e(t('connect_account')); ?>

                </a>
                <a href="<?php echo e(tenant_route('tenant.tickets.create')); ?>" target="_blank" rel="noopener noreferrer"
...
</div><?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/components/disconnected-account.blade.php ENDPATH**/ ?>