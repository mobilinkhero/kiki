...
<?php endif; ?>
        ...
        <div class="flex-1 space-y-5">
            <form wire:submit="save" x-data="{ 'only_agents_can_chat': <?php if ((object) ('only_agents_can_chat') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('only_agents_can_chat'->value()); ?>')<?php echo e('only_agents_can_chat'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('only_agents_can_chat'); ?>')<?php endif; ?> }" class="space-y-6">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo e(t('configure_support_agent')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'message','value' => t('restrict_chat_access')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'message','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(t('restrict_chat_access'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.toggle','data' => ['id' => 'agents-chat-toggle','name' => 'only_agents_can_chat','value' => $only_agents_can_chat,'wire:model' => 'only_agents_can_chat']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'agents-chat-toggle','name' => 'only_agents_can_chat','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($only_agents_can_chat),'wire:model' => 'only_agents_can_chat']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['type' => 'warning']); ?>
                                ...
                                <?php echo e(t('support_agent_feature_info')); ?>
...
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/tenant/settings/whats-mark/support-agent-settings.blade.php ENDPATH**/ ?>