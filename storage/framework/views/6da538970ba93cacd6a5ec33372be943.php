...
>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paginator->count() > 0): ?>
        <div class="items-center justify-between w-full sm:flex-1 sm:flex">
            ...
            <div>
                <?php if($paginator->hasPages() && in_array($recordCount, ['min', 'short'])): ?>
                    <nav
                        role="navigation"
                        aria-label="Pagination Navigation"
                        class="items-center justify-between sm:flex"
...
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/vendor/power-components/livewire-powergrid/src/Providers/../../resources/views/components/frameworks/tailwind/pagination.blade.php ENDPATH**/ ?>