    ...
    >
        ...
        >
            ...
            <?php if(config('livewire-powergrid.filter') === 'outside'): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filtersFromColumns->count() > 0): ?>
...
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/vendor/power-components/livewire-powergrid/src/Providers/../../resources/views/components/frameworks/tailwind/table-base.blade.php ENDPATH**/ ?>