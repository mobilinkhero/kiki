...
<?php endif; ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = app('App\Services\LanguageService')->getAvailableLanguages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $additionalClass =
        ...
        <div class="flex items-center justify-between px-4 py-2 <?php echo e($additionalClass); ?>">
            <button wire:click="setLocale('<?php echo e($language->code); ?>')"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($language->code === $currentLocale): ?>
                <span
...
<?php endif; ?><?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/language-switcher.blade.php ENDPATH**/ ?>