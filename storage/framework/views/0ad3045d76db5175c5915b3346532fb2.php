  ...
  <link rel="icon" type="image/png" sizes="32x32"
      href="<?php echo e(!empty($settings['favicon']) ? Storage::url($settings['favicon']) : $favicon_image_32); ?>}}">
  <link rel="icon" type="image/png" sizes="16x16"
      href="<?php echo e(!empty($settings['favicon']) ? Storage::url($settings['favicon']) : $favicon_image_16); ?>">
  <link rel="apple-touch-icon"
      href="<?php echo e(!empty($settings['favicon']) ? Storage::url($settings['favicon']) : $favicon_image_apple); ?>">
...
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/components/tenant-head-section.blade.php ENDPATH**/ ?>