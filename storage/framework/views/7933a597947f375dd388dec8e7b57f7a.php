...
<?php $component->withAttributes(['class' => 'rounded-md']); ?>
                    ...
                    <div class="flex flex-col gap-2 sm:flex-row">
                        <div class="relative w-fit max-w-full">
                            <select wire:model.live="selectedFile"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $logFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                                        <div x-data="{ expanded: false }" class="relative">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strlen($log['content']) > 150): ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="4"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$selectedFile): ?>
                ...
                <!-- Pagination -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logs->count() > 0 && $totalPages > 1): ?>
                    <div
...
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/Modules/LogViewer/resources/views/livewire/log-viewer.blade.php ENDPATH**/ ?>