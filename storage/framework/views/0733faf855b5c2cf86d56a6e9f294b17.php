...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(checkPermission('tenant.role.create')): ?>
    <div class="flex justify-start mb-3 px-4 lg:px-0 items-center gap-2">
        <a href="<?php echo e(tenant_route('tenant.roles.save')); ?>">
...
[$__name, $__params] = $__split('tenant.tables.tenant-role-table', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2646453437-0', null);
...
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/tenant/role/tenant-role-list.blade.php ENDPATH**/ ?>