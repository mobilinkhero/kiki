        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('E-commerce Settings')); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select wire:model="settings.currency" 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableCurrencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($code); ?>"><?php echo e($name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </select>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['settings.currency'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                           placeholder="0.00">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['settings.tax_rate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($config->google_sheets_url)): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['settings.google_sheets_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['collect_customer_details'] ?? false): ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availablePaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                        <!-- Payment Method Toggle -->
                        <div class="flex items-center space-x-3 mb-3">
                            <input type="checkbox" 
                                   wire:model="settings.enabled_payment_methods.<?php echo e($method); ?>"
                                   id="payment_<?php echo e($method); ?>"
                                   class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                            <label for="payment_<?php echo e($method); ?>" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                <?php echo e($label); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['enabled_payment_methods'][$method] ?? false): ?>
                            <div class="ml-6">
                                <label for="response_<?php echo e($method); ?>" class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">
                                    Custom Response Message
                                </label>
                                <textarea wire:model="settings.payment_method_responses.<?php echo e($method); ?>"
                                          id="response_<?php echo e($method); ?>"
                                          rows="3"
                                ...
                                <p class="text-xs text-gray-500 mt-1">This message will be sent to customers when they choose <?php echo e($label); ?>.</p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['settings.payment_method_responses.' . $method];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-700">
                    ...
                    <div class="text-xs text-gray-500 mb-2">
                        Debug: AI Mode = <?php echo e($settings['ai_powered_mode'] ? 'ON' : 'OFF'); ?>

                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['ai_powered_mode']): ?>
                        <div class="space-y-4 mt-4 pt-4 border-t border-purple-200 dark:border-purple-700">
                            ...
                            <div>
                                ...
                                <select wire:model="settings.openai_model" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableAiModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['upselling_settings']['enabled']): ?>
                        <div class="space-y-3">
                            <div>
                ...
                <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['abandoned_cart_settings']['enabled']): ?>
                        <div class="space-y-3">
                            <div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['settings.order_confirmation_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['settings.payment_confirmation_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['shipping_settings']['enabled']): ?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 mt-6">
        ...
        <div class="mb-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($serviceAccountStatus['configured']) && $serviceAccountStatus['configured']): ?>
                <div class="flex items-center p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-green-600 dark:text-green-300 text-sm">
                            <?php echo e($serviceAccountStatus['email'] ?? 'Global service account configured'); ?><br>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 mt-6">
        ...
        <div class="flex gap-3 flex-wrap mb-4">
            ...
            <a href="<?php echo e(tenant_route('tenant.ecommerce.dashboard')); ?>" 
               class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
                📊 View Dashboard
            </a>
            
            <a href="<?php echo e(tenant_route('tenant.ecommerce.products')); ?>" 
    ...
    <!-- Apps Script Modal -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showScriptModal): ?>
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                            ...
                            <ol class="text-sm text-blue-800 dark:text-blue-300 space-y-2">
                                <li><strong>1.</strong> Open your Google Sheet: <a href="<?php echo e($config->google_sheets_url ?? '#'); ?>" target="_blank" class="underline hover:no-underline"><?php echo e($config->google_sheets_url ?? 'N/A'); ?></a></li>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="appsScriptCode" 
                                      ...
                                      style="font-family: 'Courier New', monospace;"><?php echo e($generatedScript); ?></textarea>
                        </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <a href="<?php echo e($config->google_sheets_url ?? '#'); ?>" 
                           target="_blank"
    ...
    <?php echo $__env->make('livewire.tenant.ecommerce.sync-debug-console', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                            ...
                            <ol class="text-sm text-yellow-800 dark:text-yellow-300 space-y-2">
                                <li><strong>1.</strong> Open your Google Sheet: <a href="<?php echo e($config->google_sheets_url ?? '#'); ?>" target="_blank" class="underline hover:no-underline">Click here</a></li>
                        ...
                        <!-- Sheet Data -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($importData)): ?>
                            <div class="space-y-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $importData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sheetName => $sheetData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                                        <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">
                                            📊 <?php echo e($sheetName); ?> Sheet
                                        </h4>
                                        ...
                                        <div class="mb-3">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <button onclick="navigator.clipboard.writeText('<?php echo e(implode(chr(9), $sheetData['headers'])); ?>')" 
                                                        class="px-2 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">
                                                    📋 Copy Headers
                                                </button>
                                            </div>
                                            <div class="p-2 bg-gray-50 dark:bg-gray-700 rounded border text-sm font-mono">
                                                <?php echo e(implode(' | ', $sheetData['headers'])); ?>

                                            </div>
                                        </div>

                                        <!-- Sample Data -->
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($sheetData['sample_data'])): ?>
                                            <div class="mb-3">
                                                <div class="flex items-center justify-between mb-2">
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                                        Sample Data (paste in row 2):
                                                    </label>
                                                    <button onclick="navigator.clipboard.writeText('<?php echo e(implode(chr(9), $sheetData['sample_data'][0])); ?>')" 
                                                            class="px-2 py-1 text-xs bg-green-600 text-white rounded hover:bg-green-700">
                                                        📋 Copy Sample
                                                    </button>
                                                </div>
                                                <div class="p-2 bg-gray-50 dark:bg-gray-700 rounded border text-sm font-mono">
                                                    <?php echo e(implode(' | ', $sheetData['sample_data'][0])); ?>
                                        ...
                                        <!-- CSV Download -->
                                        <div class="mt-3">
                                            <button onclick="downloadCSV('<?php echo e($sheetName); ?>', `<?php echo e($sheetData['csv_content']); ?>`)" 
                                                    class="px-3 py-1 text-sm bg-purple-600 text-white rounded hover:bg-purple-700">
                                                💾 Download <?php echo e($sheetName); ?>.csv
                                            </button>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="mt-8 flex justify-center space-x-4">
        ...
        <button wire:click="saveSettings" 
                onclick="console.log('🔧 Save button clicked!'); console.log('Livewire component:', window.Livewire.find('<?php echo e($_instance->getId()); ?>'));"
                class="px-8 py-3 bg-blue-600 text-white text-lg font-semibold rounded-xl hover:bg-blue-700 transition-colors shadow-lg">
            💾 Save All Settings
        </button>
    </div>
</div>
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/tenant/ecommerce/settings.blade.php ENDPATH**/ ?>