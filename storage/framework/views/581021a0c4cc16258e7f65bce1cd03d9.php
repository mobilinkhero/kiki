...
<?php endif; ?>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['site_logo' => '22px x 40px', 'dark_logo' => '22px x 40px', 'favicon' => '12px x
                            ...
                            ?>
                            <div class="w-full upload-section" x-data="fileUploader('<?php echo e($key); ?>', <?php echo e($hasImage ? 'true' : 'false'); ?>, <?php echo \Illuminate\Support\Js::from($imagePath)->toHtml() ?>)">
                                ...
                                <div class="relative p-6 border-2 border-dashed rounded-lg cursor-pointer hover:border-info-500 transition duration-300 bg-gray-50 dark:bg-gray-800"
                                    ...
                                    <div class="relative inline-block" x-show="preview" x-cloak>
                                        <img :src="preview" alt="Image Preview"
                                            class="object-contain rounded-lg shadow-md <?php echo e($key === 'favicon' ? 'h-12 w-12' : ($key === 'cover_page_image' ? 'h-32 w-full max-w-md' : 'h-24 w-48')); ?>" />
                                        <button type="button"
...
<?php endif; ?>
                                    ...
                                    <div class="relative inline-block" x-show="!preview && hasExistingImage && existingImagePath" x-cloak>
                                        ...
                                        <button type="button"
                                            class="absolute -top-4 -right-4 bg-danger-500 text-white rounded-full shadow-lg hover:bg-danger-600 p-1 z-10"
                                            x-on:click.stop="confirmDelete($event, () => { hasExistingImage = false; existingImagePath = null; clearImage(); $wire.removeSetting('<?php echo e($key); ?>'); setTimeout(() => { location.reload(); }, 1500);})">
                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-s-x-circle'); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-12 w-12 text-gray-400 dark:text-gray-500 mx-auto']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                            ...
                            <!-- Form Actions -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(checkPermission('admin.website_settings.edit')): ?>
...
</script><?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/admin/settings/website/theme-settings.blade.php ENDPATH**/ ?>