...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($api_verification_warning): ?>
...
<?php endif; ?>
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-warning-800 dark:text-warning-200">
                    <?php echo e(t('connection_verification_warning') ?? 'Connection Verification Issue'); ?>

                </h3>
                <div class="mt-2 text-sm text-warning-700 dark:text-warning-300">
                    <p><?php echo e(t('api_verification_failed_message') ?? 'Your WhatsApp account is still connected, but we couldn\'t verify it with Facebook API right now. This is usually temporary. Your messages will continue to work normally.'); ?></p>
                    <p class="mt-2 font-semibold">⚠️ <?php echo e(t('do_not_reconnect_warning') ?? 'Do NOT reconnect unless messages are actually not working, as reconnecting may cause duplicate messages.'); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php $component->withAttributes(['class' => '-mx-4 sm:-mx-0 rounded-md']); ?>
                     <?php $__env->slot('header', null, []); ?> 
                        <div class="flex items-center justify-between">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$admin_webhook_connected): ?>
                            <span
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($embedded_signup_configured): ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-8 w-8 text-primary-600 dark:text-primary-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                                ...
                                <h4 class="text-lg font-semibold text-primary-900 dark:text-primary-100 mb-2">
                                    <?php echo e(t('embedded_signup') ?? 'Embedded Signup'); ?>

                                </h4>
                                <p class="text-sm text-primary-700 dark:text-primary-300 mb-6 max-w-2xl mx-auto">
                                    <?php echo e(t('emb_signup_info') ?? 'Seamlessly authenticate users with their Facebook account using our embedded sign-in feature. No redirects, just smooth onboarding'); ?>
                                ...
                                <div x-data="{ 
                                    ...
                                    <button type="button" 
                                        ...
                                        <span x-show="!embeddedLoading"><?php echo e(t('connect_with_facebook') ?? 'Connect with Facebook'); ?></span>
                                        <span x-show="embeddedLoading" x-cloak><?php echo e(t('connecting') ?? 'Connecting'); ?>...</span>
                                    </button>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($is_whatsmark_connected) && !$is_whatsmark_connected && $step == 1): ?>
                        <div class="mt-4 p-3 bg-warning-50 dark:bg-warning-900/30 rounded-md">
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($wm_default_phone_number) && $wm_default_phone_number): ?>
                        <div
...
<script>
    ...
    (function() {
        ...
        window.fbAsyncInit = function() {
            FB.init({
                appId: '<?php echo e($admin_fb_app_id); ?>',
        ...
        window.launchWhatsAppSignup = function() {
            ...
            const sendSetupData = function() {
                if (tempAccessCode && waBaId && !isFinished) {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').handleEmbeddedSignup(tempAccessCode, waBaId, phoneNumberId)
                        .then(function() {
            ...
            FB.login(function(response) {
                if (response.authResponse) {
                    ...
                    setupTimeout = setTimeout(function() {
                        if (!isFinished && authReceived) {
                            ...
                            resetLoadingState();
                            alert('<?php echo e(t("setup_timeout_message") ?? "Setup timeout: Please complete the WhatsApp setup flow and click Finish within 2 minutes."); ?>');
                        }
                ...
                config_id: '<?php echo e($admin_fb_config_id); ?>',
                response_type: 'code',
                            ...
                            if (tempAccessCode) {
                                ...
                                const waitInterval = setInterval(function() {
                                    ...
                                    if (tempAccessCode) {
                                        ...
                                        clearInterval(waitInterval);
                                        resetLoadingState();
                                        alert('<?php echo e(t("setup_failed_no_auth_code") ?? "Setup failed: Could not retrieve authorization code from Facebook."); ?>');
                                    }
                                }, 100);
                            }
                        } 
...
<?php $__env->stopPush(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/tenant/waba/connect-waba.blade.php ENDPATH**/ ?>