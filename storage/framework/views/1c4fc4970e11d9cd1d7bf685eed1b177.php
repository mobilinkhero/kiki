...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'syncLanguage','wire:loading.attr' => 'disabled','wire:loading.class' => 'opacity-75 cursor-not-allowed animate-pulse','class' => 'transition-all duration-200 active:scale-95']); ?>
      <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
      <span wire:loading.remove wire:target="syncLanguage"><?php echo e(t('sync_languages')); ?></span>
...
[$__name, $__params] = $__split('admin.tables.language-table', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2548866563-0', null);
...
</div><?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/livewire/admin/settings/language/language-manager.blade.php ENDPATH**/ ?>