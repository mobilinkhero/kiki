                                ...
                                <div
                                    ...
                                    <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->getPaymentDate()): ?>
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($additionalDetails)): ?>
                                                    <dl class="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $additionalDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->getPaymentDetailsText()): ?>
                                        <div class="col-span-2">
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->getGatewayStatus()): ?>
                                        <div>
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                                Gateway Status
                                            </dt>
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->getAmountReceived()): ?>
                                        <div>
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                                Amount Received
                                            </dt>
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->getGatewayTransactionId()): ?>
                                        <div class="col-span-2">
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                            ...
                            <div class="overflow-x-auto border border-gray-200 dark:border-slate-700 rounded-md">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                                    ...
                                    <tbody
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $transaction->invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="px-6 py-4">
                                    ...
                                    <tfoot class="bg-gray-50 dark:bg-slate-700">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->invoice->hasCoupon()): ?>
                                        <tr>
                                            <td colspan="3"
                                                class="px-6 py-3 text-sm font-medium text-right text-gray-500 dark:text-gray-300">
...
<?php endif; ?> <?php echo e(t('coupon_discount')); ?> (<?php echo e($transaction->invoice->coupon_code); ?>)
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($taxDetails) > 0): ?>
                                        <!-- Tax Details Rows -->
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $taxDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td colspan="3"
                                                class="px-6 py-3 text-sm font-medium text-right text-gray-500 dark:text-gray-300">
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->invoice->fee > 0): ?>
                                        <tr>
                                            <td colspan="3"
                                                class="px-6 py-3 text-sm font-medium text-right text-gray-500 dark:text-gray-300">
                                                <?php echo e(t('fee')); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($remainingCredit > 0 && $transaction->status == 'pending'): ?>
                                        <tr class="bg-primary-50 dark:bg-slate-700">
                                            <td colspan="3"
                                                class="px-6 py-3 text-sm font-medium text-right text-gray-900 dark:text-gray-100">
...
<?php unset($__componentOriginal53747ceb358d30c0105769f8471417f6); ?>
<?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(checkPermission('admin.transactions.actions')): ?>
                <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-success-700 dark:text-success-300">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->updated_at): ?>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-danger-700 dark:text-danger-300">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->error): ?>
...
<?php endif; ?>
<?php /**PATH /home/u108339042/domains/dash.chatvoo.com/public_html/resources/views/admin/transactions/show.blade.php ENDPATH**/ ?>